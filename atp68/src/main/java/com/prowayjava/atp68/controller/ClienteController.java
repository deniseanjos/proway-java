package com.prowayjava.atp68.controller;
...
import com.prowayjava.atp68.repository.ClienteRepository;
...
public class ClienteController {
	...
	@GetMapping("/cliente")
	public String clientes(Model req, String nome) {
		List<Cliente> lista;
		if(nome != null) {
			lista = (List<Cliente>)repository.findByNome(nome);
		} else {
			lista = (List<Cliente>)repository.findAll();
		}
